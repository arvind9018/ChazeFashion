...
TEMPLATES = [
    {
        ...
        'DIRS': ['templates'], # Or [os.path.join(BASE_DIR, 'templates')] if you have a project-level templates folder
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                ...
                'catalog.context_processors.cart_total_items', # ADD THIS LINE
            ],
        },
    },
]
